...
**Javauto Lookup** helps a user find relevant documentation for a specific function.
 ...
 Get the latest version of [Javauto Lookup](https://github.com/Javauto/javauto-lookup/releases/tag/v1.0.0) and run  **'$ java -jar javauto-lookup --doc functionName'** would provide documentation information for the **functionName** function.
